...
- [Optical character recognition](https://github.com/IbnuGunawanPrayogo/ocr-googlecloud) - Simple OCR(Optical character recognition) using node js with gcloud vision.
